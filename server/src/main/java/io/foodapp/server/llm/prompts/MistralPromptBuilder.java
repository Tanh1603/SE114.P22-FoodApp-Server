...
@Component
@AllArgsConstructor
public class MistralPromptBuilder {
    ...
    public String buildFoodSuggestionPrompt(List<Order> orders, List<Food> allFoods) {
        ...
        prompt.append("""
                                Yêu cầu:
                - Trả về đúng một mảng JSON gồm **5 id món ăn được gợi ý**, định dạng như sau (ví dụ):
                  `[12, 5, 8, 3, 19]`
                ...
                - Nếu khách chưa từng đặt món nào, hãy gợi ý dựa theo rating cao nhất.
