...
public class VoucherController {
    ...
    @GetMapping
    public ResponseEntity<PageResponse<VoucherResponse>> getVouchers(@ModelAttribute PageFilter filter) {
        Page<VoucherResponse> responses = voucherService.getVouchers(PageFilter.toPageAble(filter));
